...
(def-doom-theme doom-cobalt2
  ...
  (((cursor &override) :background "#F4D300")
   ...
   (web-mode-function-name-face :foreground green)
   (web-mode-string-face :foreground yellow)
   (web-mode-keyword-face :foreground red :weight 'bold)
   (web-mode-type-face :foreground cyan)
   (web-mode-variable-name-face :foreground fg)
   (web-mode-constant-face :foreground orange)
   ...
   (web-mode-css-at-rule-face :foreground violet)
   (web-mode-css-pseudo-class-face :foreground teal)
   ...
   (js2-private-function-call :foreground green)
   ...
   ;;;; sql-mode
   (font-lock-sql-keyword-face :foreground red :weight 'bold)

   ;;;; sh-mode / bash
   (sh-heredoc :foreground yellow)
   (sh-quoted-exec :foreground teal)
