...
(setq centaur-theme 'doom-cobalt2)                   ; Color theme: auto, random, system, default, pro, dark, light, warm, cold, day or night doom-cobalt2
...
(setq centaur-lsp t)                   ; Set LSP t or nil
...
(defun centaur-setup-fonts ()
  ...
  (when (display-graphic-p)
    ...
    (cl-loop for font in '("Sarasa Mono SC" "LXGW WenKai Mono" "FiraCode Nerd Font" "CaskaydiaCove Nerd Font"
                           ...
                           "Monaco" "DejaVu Sans Mono" "Consolas" "Maple Mono")
